...
export const INSTITUTES: Institute[] = [
  ...
  },
  {
    ...
    nameAr: "معهد كامبرايت الدولي للغات",
    description: "معهد لغة إنجليزية دولي في Wisma MCA — منطقة KLCC. بيئة متعددة الجنسيات مع تركيز على المحادثة والتواصل. برامج: أكاديمي 4h/يوم، مكثف 6h/يوم، IELTS، حصص خاصة، وسامر كامب للأطفال 7-15 سنة. فيزا: 6 أشهر = 2,000 RM | سنة = 2,900 RM.",
    goals: ["ielts", "general"],
    minBudget: 2650,
    maxBudget: 22430,
    color: "#1a2a6c",
    programs: [
      // Academic Program — 4h/day
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "شهر واحد", price: 2650 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "شهرين", price: 4664 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "3 أشهر", price: 6360 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "4 أشهر", price: 7791 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "5 أشهر", price: 9222 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "6 أشهر", price: 10441 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "7 أشهر", price: 11660 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "8 أشهر", price: 12720 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "9 أشهر", price: 13992 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "10 أشهر", price: 14787 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "11 شهراً", price: 15794 },
      { name: "البرنامج الأكاديمي — 4 ساعات/يوم", duration: "12 شهراً", price: 16483 },
      // Intensive Program — 6h/day (4h academic + 2h speaking)
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "شهر واحد", price: 3551 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "شهرين", price: 6413 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "3 أشهر", price: 8745 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "4 أشهر", price: 10812 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "5 أشهر", price: 12773 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "6 أشهر", price: 14416 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "7 أشهر", price: 16027 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "8 أشهر", price: 17437 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "9 أشهر", price: 19032 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "10 أشهر", price: 20140 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "11 شهراً", price: 21465 },
      { name: "البرنامج المكثف — 6 ساعات/يوم", duration: "12 شهراً", price: 22430 },
      // Speaking class (standalone)
      { name: "حصة محادثة — 2 ساعة", duration: "جلسة واحدة", price: 50 },
      // Summer Camp
      { name: "سامر كامب أطفال (7-15 سنة)", duration: "أسبوع واحد", price: 2200 },
      { name: "سامر كامب أطفال (7-15 سنة)", duration: "أسبوعان", price: 2700 },
      { name: "سامر كامب أطفال (7-15 سنة)", duration: "3 أسابيع", price: 3000 },
      { name: "سامر كامب أطفال (7-15 سنة)", duration: "4 أسابيع", price: 3600 },
    ],
    intakes: ["يناير", "فبراير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
    address: "Wisma MCA, Jalan Ampang, KLCC District, 50450 Kuala Lumpur",
  },
  {
    id: "erican",
