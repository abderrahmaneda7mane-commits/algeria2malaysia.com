...
export const translations = {
  ...
  services: {
    ...
    instLabel:  { ar: "معاهد اللغة الإنجليزية", en: "English Language Institutes", fr: "Instituts de langue anglaise" },
    instDesc:   { ar: "IELTS، إنجليزي عام، أعمال، أطفال، سامر كامب", en: "IELTS, General English, Business, Kids, Summer Camp", fr: "IELTS, anglais général, affaires, enfants, camp d'été" },
  ...
  instTrack: {
    ...
    desc:    { ar: "6 معاهد معتمدة في قلب كوالالمبور — IELTS، إنجليزي عام، أعمال، أطفال، وسامر كامب", en: "6 certified institutes in central KL — IELTS, General English, Business, Kids, Summer Camp", fr: "6 instituts certifiés au cœur de KL — IELTS, anglais général, affaires, enfants, camp d'été" },
  ...
  quiz: {
    ...
    q1: {
      ...
      international: { ar: "بيئة دولية — أقل عربي",            en: "International Environment",          fr: "Environnement international" },
      ...
      internationalD: { ar: "أقل نسبة متحدثين بالعربية — تحسين المحادثة بشكل طبيعي", en: "Fewer Arabic speakers — improve speaking naturally", fr: "Moins d'arabophones — améliorer la communication naturellement" },
    },
    q2: {
      ...
      weekly: { ar: "أسبوع إلى 4 أسابيع", en: "1 to 4 weeks",   fr: "1 à 4 semaines" },
      ...
      weeklyD:{ ar: "تأشيرة سياحية — مثالي لسامر كامب", en: "Tourist visa — ideal for summer camp", fr: "Visa touristique — idéal pour camp d'été" },
