...
export const translations = {
  ...
  instTrack: {
    ...
    desc:    { ar: "5 معاهد معتمدة في قلب كوالالمبور — IELTS، إنجليزي عام، أعمال، أطفال، وسامر كامب", en: "5 certified institutes in central KL — IELTS, General English, Business, Kids, Summer Camp", fr: "5 instituts certifiés au cœur de KL — IELTS, anglais général, affaires, enfants, camp d'été" },
