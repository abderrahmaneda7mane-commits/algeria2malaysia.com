...
export const translations = {
  ...
  quiz: {
    ...
    q1: {
      ...
      international: { ar: "أقل نسبة طلاب عرب 🌍",              en: "International Environment",          fr: "Environnement international" },
      ...
      internationalD: { ar: "أريد معهد فيه أقل نسبة من الطلاب المتحدثين بالعربية", en: "I want an institute with fewer Arabic-speaking students", fr: "Je veux un institut avec moins d'étudiants arabophones" },
    },
    q2: {
