...
export default function EricanPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      {/* ── Header ── */}
      <div className="bg-gradient-to-br from-[#3d1a6e] via-[#5a2a9a] to-[#6d3ab0] text-white pt-20 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-extrabold leading-tight">مركز إيريكان للغات</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-8">
        ...
        <div className="bg-gradient-to-r from-[#3d1a6e] to-[#5a2a9a] rounded-2xl p-6 mb-8 text-white text-center">
          ...
          <p className="text-purple-100 text-sm mb-5">تواصل معنا وسنساعدك في إتمام عملية القبول والتأشيرة خطوة بخطوة</p>
