...
export default function SheffieldPage() {
  useSEO({
    title: "كلية شيفيلد ماليزيا — بريطاني الأسلوب، طريق الجامعة 2025",
    description: "Sheffield College Malaysia في Damansara: Foundation English، IELTS، Cambridge، وPathway للجامعات. يبدأ من 3,400 RM/شهر. للطلاب الجزائريين الطموحين.",
    canonicalPath: "/english-course-sheffield-kl",
    ...
    <div className="min-h-screen bg-[#f8fafc]" dir="rtl">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0d1f4e] via-[#1a3272] to-[#1e3d8a] text-white pt-20 pb-24 px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-black leading-tight">أكاديمية شيفيلد للغات</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-6 relative z-10">
        ...
        <div className="bg-gradient-to-r from-[#0d1f4e] to-[#1a3272] rounded-2xl p-6 mb-8 text-white text-center">
          ...
          <p className="text-blue-100 text-sm mb-5">عبّئ فورم المعهد وسنتواصل معك لاختيار أفضل باقة وإتمام عملية القبول خطوة بخطوة</p>
          <div className="flex justify-center">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-white text-[#0d1f4e] hover:bg-blue-50 font-bold text-sm rounded-xl px-8 py-3 transition-all shadow-md"
            >
