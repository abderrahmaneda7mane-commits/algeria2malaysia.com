    ...
    return [
      {
        ...
        reason: "Cambright يتميز بأقل نسبة متحدثين بالعربية بين معاهد كوالالمبور — طلاب من جنسيات مختلفة، الإنجليزية هي لغة التواصل الوحيدة. مثالي لمن يريد تحسين المحادثة بشكل طبيعي وسريع بعيداً عن الجو العربي",
